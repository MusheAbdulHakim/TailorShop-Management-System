<?php 
	...
	if (isset($_POST['add_category'])) {
		$title = htmlspecialchars($_POST['category_name']);
		$add_category = DB::insert('expense_category',[
			'title'=>$title
		]);
		if ($add_category) {
			echo "<script>alert('New Expense Category has been added');</script>";
			echo "<script>document.location.href='expense-categories'</script>";
		}
	}
	...
	<div class="app-content content">
				...
				<div class="row">
						...
						<div class="row breadcrumbs-top">
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active">All Expense Categories
									</li>
								</ol>
							</div>
						</div>
					...
					<div class="content-header-right col-md-3 col-12">
						<div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
							...
							<button class="btn btn-primary roundbox-shadow-2 px-2 mb-1" type="button" aria-haspopup="true" data-toggle="modal" data-target="#add-category" aria-expanded="true">Add Category</button>
							</div>
					</div>
				</div>
			</div>
		...
		<div class="content-wrapper">
			<div class="content-body">
									...
									<div class="card-body card-dashboard">
											...
											<div class="table-responsive">
												<table class="table table-striped table-bordered dataex-html5-export">
													...
													<tbody>
														<?php 
															$expense_categories = DB::query("SELECT * from expense_category");
															$roll = 0;
														 ...
														 <tr>
														 	<td><?php echo $roll; ?></td>
														 	<td><?php echo htmlspecialchars_decode($expense_category['title']); ?></td>
														 	<td>
				...
				<!--/ HTML5 export buttons table -->                      
				<!-- include expense category modals -->
				<?php include_once 'templates/modals/expense_category_modals.php'; ?>
			</div>
		</div>
	</div>
	<!-- END: Content-->
