<?php 
	...
	if (isset($_POST['add_category'])) {
		...
		$add_category = DB::insert('income_category',[
			'title'=>$title
		]);
		if ($add_category) {
			echo "<script>alert('New Income Category has been added');</script>";
			echo "<script>document.location.href='income-categories'</script>";
		}
	}
	...
	<div class="app-content content">
						...
						<div class="row breadcrumbs-top">
							<div class="breadcrumb-wrapper col-12">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="#">Income Category</a>
									</li>
		...
		<div class="content-wrapper">
			<div class="content-body">
									...
									<div class="card-body card-dashboard">
											...
											<div class="table-responsive">
												<table class="table table-striped table-bordered dataex-html5-export">
													...
													<tbody>
														<?php 
															$income_categories = DB::query("SELECT * from income_category");
															$roll = 0;
														 ...
														 <tr>
														 	<td><?php echo $roll; ?></td>
														 	<td><?php echo htmlspecialchars_decode($income_category['title']); ?></td>
														 	<td>
				...
				<!--/ HTML5 export buttons table -->                      
				<!-- include income category modals -->
				<?php include_once 'templates/modals/income_category_modals.php'; ?>
			</div>
		</div>
	</div>
	<!-- END: Content-->
