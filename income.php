<?php 
	...
	if (isset($_POST['add_income'])) {
		...
		if ($add_income) {
			echo "<script>alert('New Income has been added');</script>";
			echo "<script>document.location.href='income'</script>";
		}
	}
	...
	<div class="app-content content">
				...
				<div class="row">
					...
					<div class="content-header-right col-md-3 col-12">
						<div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
							...
							<button class="btn btn-primary roundbox-shadow-2 px-2 mb-1" type="button" aria-haspopup="true" data-toggle="modal" data-target="#add-income" aria-expanded="true">Add Income</button>
							</div>
					</div>
				</div>
			</div>
		...
		<div class="content-wrapper">
			<div class="content-body">
					...
					<div class="row">
						<div class="col-12">
                            ...
                            <th>Action</th>
													...
													<tbody>
														<?php 
															$incomes = DB::query("SELECT * FROM income");
															$roll = 0;
														 ...
														 <tr>
														 	...
														 	<td><?php echo htmlspecialchars_decode($income['income_category']); ?></td>
														 	<td><?php echo htmlspecialchars_decode($income['description']); ?></td>
														 	<td><?php echo htmlspecialchars_decode($income['date']); ?></td>
														 	
														 	<td><?php echo currency. htmlspecialchars_decode($income['amount']); ?></td>
				...
				<?php include_once 'templates/modals/income_modals.php'; ?>
			</div>
		</div>
	</div>
	<!-- END: Content-->
