! function(a, e, t) { "use strict"; if (t(".customizer-toggle").on("click", (function() { t(".customizer").toggleClass("open") })), t(".customizer-close").on("click", (function() { t(".customizer").removeClass("open") })), t(".customizer-content").length > 0) new PerfectScrollbar(".customizer-content"); var s = t("body"),
