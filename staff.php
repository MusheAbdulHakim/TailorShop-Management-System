<?php 
	...
	if (isset($_POST['add_staff'])) {
		...
		if ($add_staff) {
			...
			echo "<script>document.location.href='staff'</script>";
		}
	}
	...
	<div class="app-content content">
				...
				<div class="row">
					...
					<div class="content-header-right col-md-3 col-12">
						<div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
							<button class="btn btn-primary roundbox-shadow-2 px-2 mb-1" type="button" aria-haspopup="true" data-toggle="modal" data-target="#add-staff" aria-expanded="true">Add Staff</button>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="content-wrapper">
			<div class="content-body">
												...
												<table class="table table-striped table-bordered dataex-html5-export">
													...
													<tbody>
														<?php 
														 ...
														 <tr>
														 	<td><?php echo $roll; ?></td>
														 	<td><?php echo htmlspecialchars_decode($staff['Designation']); ?></td>
														 	<td><?php echo htmlspecialchars_decode($staff['FullName']); ?></td>
														 	<td><?php echo htmlspecialchars_decode($staff['Address']); ?></td>
														 	<td><?php echo htmlspecialchars_decode($staff['Phone']); ?></td>
														 	<td><?php echo htmlspecialchars_decode($staff['Gender']); ?></td>
														 	<td><?php echo currency. htmlspecialchars_decode($staff['Salary']); ?></td>
				...
				<?php include_once 'templates/modals/staff_modals.php'; ?>
			</div>
		</div>
	</div>
	<!-- END: Content-->
